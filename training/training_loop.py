...
def save_image_grid(img, fname, drange, grid_size, wandb_export=True, iterations=0):
    lo, hi = drange
    ...
    image.save(fname)
    if wandb_export:
        wandb.log(dict(image=wandb.Image(fname)), step=iterations)
...
def training_loop(
    ...
    common_kwargs = dict(c_dim=training_set.label_dim,
                         img_resolution_h=training_set.resolution_h,
                         img_resolution_w=training_set.resolution_w,
    ...
    if rank == 0:
        ...
        save_image_grid(images, os.path.join(run_dir, 'fakes_init.png'), drange=[-1,1], grid_size=grid_size,
                        wandb_export=True, iterations=0)
    ...
    while True:
        ...
        if (rank == 0) and (image_snapshot_ticks is not None) and (done or cur_tick % image_snapshot_ticks == 0):
            ...
            save_image_grid(images, os.path.join(run_dir, f'fakes{cur_nimg//1000:06d}.png'), drange=[-1,1], grid_size=grid_size,
                            wandb_export=True, iterations=cur_nimg)
